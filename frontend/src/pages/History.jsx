    ...
    return (
      <div className="min-h-screen bg-gray-50 px-6 py-16">
        <div className="mx-auto max-w-6xl">
          <h1 className="text-center text-5xl font-black">Interview History</h1>
      ...
      <div className="mx-auto max-w-6xl">
        ...
        {interviews.length === 0 ? (
          <div className="mt-12 rounded-3xl border border-gray-200 bg-white p-12 text-center shadow-sm">
            ...
            <h2 className="mt-6 text-2xl font-bold">No interviews yet</h2>

            <p className="mt-3 text-gray-500">
              Complete your first AI interview and your results will appear
              here.
            </p>
          </div>
        ) : (
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2">
              {interviews.map((interview) => (
                <div
                  ...
                  className="cursor-pointer rounded-3xl border border-gray-200 bg-white p-7 shadow-sm transition hover:-translate-y-1 hover:shadow-xl"
                >
                  {/* Top */}
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <h2 className="text-2xl font-black">{interview.role}</h2>
          ...
          >
            ...
            <div className="space-y-6 p-6 sm:p-8">
              ...
              >
                ...
                <p className="mt-1 text-gray-500">out of 100</p>
              </div>
